...
import InputField, { InputRangeField, InputSelectionField, InputType, makeDisplayText, PLAIN_TEXT_REGEX } from './inputField';
...
export const EDIT_CONTENT_FIELDS:InputField[] = [
    ...
    new InputField({title: 'Description', field: 'description',  type: InputType.PARAGRAPH, length:{min: 0, max: 300} }),
