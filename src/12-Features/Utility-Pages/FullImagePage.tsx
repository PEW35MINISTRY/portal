...
const FullImagePage = (props:{imageType?:ImageDefaultEnum, fullPage?:boolean, message?:string, primaryButtonText?:string, onPrimaryButtonClick?:()=>void, alternativeButtonText?:string, onAlternativeButtonClick?:()=>void}) => { 

  return (
      <div id='full-image-page' className={props.fullPage ? 'full-page' : ''} >
